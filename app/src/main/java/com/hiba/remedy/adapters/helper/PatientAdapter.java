...
//    "user_id":"1"},
    ...
    public PatientAdapter(List<PatientList> patientLists, Context context, FragmentManager fragmentManager) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.tv_patient_name.setText( itemList.getPatient_name());
        holder.tv_symptoms.setText(itemList.getSymptoms());
