...
public class DoctorsAdapter extends RecyclerView.Adapter<DoctorsAdapter.MyViewHolder>{
    ...
    public DoctorsAdapter(List<DoctorsList> doctorsLists, Context context, FragmentManager fragmentManager,RemedyHelper remedyHelper) {
    ...
    @Override
    public DoctorsAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DoctorsAdapter.MyViewHolder holder, int position) {
