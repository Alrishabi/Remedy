...
public class LaboratoryUserActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laboratory_user);
        initeContext();
        initLayout();
    }
    ...
    public void initLayout() {
        ...
        if(remedyHelper.getValueOfKey("app_language").equals("en")){
            setTitle(getResources().getString(R.string.labortory)+" "+getResources().getString(R.string.account));

        }else {
            setTitle(getResources().getString(R.string.account)+" "+getResources().getString(R.string.labortory));
