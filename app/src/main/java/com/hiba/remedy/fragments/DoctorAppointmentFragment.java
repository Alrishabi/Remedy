...
public class DoctorAppointmentFragment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    @SuppressLint("ValidFragment")
    public DoctorAppointmentFragment(Activity activity) {
    ...
    public  void initiateLayout(View view){
        ...
        mAdapter = new HospitalAppointmentAdapter(appointmentLists,getContext(),getFragmentManager());
...
//                parameters.put("user_id",remedyHelper.getValueOfKey("u"));
